...
<!-------------------------------->
                        <div class="row">
                            <div class="col-md-6 text-right" style="padding: 10px;"><label class="col-form-label" style="font-family: 'Baloo Bhaijaan', cursive;font-size: 16px;background-color: rgba(0,0,0,0.2);padding: 9px;">الوحدة بالعربي</label></div>
                            <div class="col-md-6 text-left" style="padding: 12px;"><input type="text" style="height: 40px;" id="qt_ar_id"></div>
                        </div>
                    </div>
                </div>
<!-------------------------------->
                <div style="margin: 10px;">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6 text-right" style="padding: 10px;"><label class="col-form-label" style="font-family: 'Baloo Bhaijaan', cursive;font-size: 17px;background-color: rgba(0,0,0,0.2);padding: 9px;">الوحدة بالانجليزي</label></div>
                            <div class="col-md-6 text-left" style="padding: 12px;"><input type="text" style="height: 40px;" id="qt_an_id"></div>
                        </div>
                    </div>
                </div>
...
<!-------------------------------->
                <div style="margin: 10px;">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-md-6 text-right" style="padding: 10px;"><label class="col-form-label" style="font-family: 'Baloo Bhaijaan', cursive;font-size: 17px;background-color: rgba(0,0,0,0.2);padding: 9px;">الكمية</label></div>
                            <div class="col-md-6 text-left" style="padding: 12px;"><input type="text" style="height: 40px;" id="qt_id"></div>
                        </div>
                    </div>
                </div>
...
<!---------------------------------------->
    ...
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center"><label class="col-form-label border rounded border-secondary shadow" style="padding: 10px;font-size: 21px;margin: 1px;background-color: rgb(231,231,231);color: rgb(0,0,0);padding-top: 3px;padding-bottom: 3px;">قائمة المخزون<br>Stock List<br></label></div>
            </div>
        </div>
    </div>
    <div class="col">
...
$(document).ready(function(){
 ...
 $('#image_form').submit(function(event){
  ...
  event.preventDefault();
     ...
     var qt_ar=$('#qt_ar_id').val();
     var qt_an=$('#qt_an_id').val();
     var qt=$('#qt_id').val();
    $.ajax({
     url:"Stock_action.php",
     method:"POST",
     data: {qt_ar:qt_ar,qt_an:qt_an,qt:qt,id:id,action:action},
     success:function(data)
     {
      fetch_data();
      $('#image_form')[0].reset();
