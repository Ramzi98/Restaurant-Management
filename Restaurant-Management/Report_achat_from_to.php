...
<head>
    ...
    <title>تقرير المشتريات من اي</title>
...
<body style="background-color: #ffd69b;">
    <div class="col text-center"><input id="arriver" type="date" style="height: 30px;margin: 10px;width: 160px;"><label class="text-center border rounded shadow" style="margin: 10px;font-size: 23px;background-color: #ffb648;width: 50px;">الى</label><input type="date" style="width: 160px;margin: 10px;height: 30px;" id="depart">
        <label
            class="text-center border rounded shadow" style="margin: 10px;font-size: 23px;background-color: #ffb648;width: 50px;">من</label>
    </div>
