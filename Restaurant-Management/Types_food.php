...
<!-------------------------------->
            <div style="margin: 10px;"  >
                    <div class="container" >
                        ...
                        <div class="row">
                            <div class="col-md-6 text-right" style="padding: 10px;"><label class="col-form-label" style="font-family: 'Baloo Bhaijaan', cursive;font-size: 16px;background-color: rgba(0,0,0,0.2);padding: 9px;">النوع الرئيسي</label></div>
                            <div class="col-md-6 text-left" style="padding: 12px;"><input type="text" style="height: 40px;" id="Plat_ar_id"></div>
                        </div>
                    </div>
                </div>
<!-------------------------->
             <div style="margin: 10px;"  >
                    <div class="container" >
                        ...
                        <div class="row">
                            <div class="col-md-6 text-right" style="padding: 10px;"><label class="col-form-label" style="font-family: 'Baloo Bhaijaan', cursive;font-size: 16px;background-color: rgba(0,0,0,0.2);padding: 9px;">النوع الريئسي بالانجليزية</label></div>
                            <div class="col-md-6 text-left" style="padding: 12px;"><input type="text" style="height: 40px;" id="Plat_an_id"></div>
                        </div>
                    </div>
                </div>
               </div>
...
<!--------------------Second part ------>
    ...
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center"><label class="col-form-label border rounded border-secondary shadow" style="padding: 10px;font-size: 21px;margin: 1px;background-color: rgb(231,231,231);color: rgb(0,0,0);padding-top: 3px;padding-bottom: 3px;">القائمة<br>List<br></label></div>
            </div>
        </div>
    </div>
    <div class="col">
    ...
    <div
        ...
        <button
            class="btn btn-success text-center" id="add" type="button" style="margin: 10px;font-size: 18px;">جديد<i class="fa fa-plus float-left" style="margin: 5px;font-size: 16px;margin-top: 9px;margin-right: 10px;"></i></button>
            </div>
...
$(document).ready(function(){
 ...
 $('#image_form').submit(function(event){
  ...
  var id;
     ...
     var name_ar=$('#Plat_ar_id').val();
     var name_an=$('#Plat_an_id').val();
    $.ajax({
     url:"Types_food_action.php",
     method:"POST",
     data: {name_an:name_an,name_ar:name_ar,action:action,id:id},
     success:function(data)
     {
      fetch_data();
      $('#image_form')[0].reset();
