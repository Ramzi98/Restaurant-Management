...
session_start();
 ...
 $b=0; $query = "SELECT sum(price) FROM achat where data between '$d' and '$v' ";
...
<body style="background-color: #ffd69b;">
    <div class="col text-center"><label class="col-form-label text-center border rounded border-secondary shadow" style="padding: 15px;background-color: rgb(231,231,231);width: 150px;margin: 15px;">الشهر</label></div>
