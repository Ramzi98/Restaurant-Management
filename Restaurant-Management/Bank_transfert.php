...
<!------------------------------wasfe-->
            <div style="margin: 10px;"  >
                    <div class="container" >
                        ...
                        <div class="row">
                            <div class="col-md-6 text-right" style="padding: 10px;"><label class="col-form-label" style="font-family: 'Baloo Bhaijaan', cursive;font-size: 16px;background-color: rgba(0,0,0,0.2);padding: 9px;">الوصف</label></div>
                            <div class="col-md-6 text-left" style="padding: 12px;"><input type="text" style="height: 40px;" id="des_id"></div>
                        </div>
                    </div>
                </div>
<!-------------------------prix-->
            <div style="margin: 10px;"  >
                    <div class="container" >
                        ...
                        <div class="row">
                            <div class="col-md-6 text-right" style="padding: 10px;"><label class="col-form-label" style="font-family: 'Baloo Bhaijaan', cursive;font-size: 16px;background-color: rgba(0,0,0,0.2);padding: 9px;">المبلغ</label></div>
...
<!-------------------------->
             <div style="margin: 10px;"  >
                    <div class="container" >
                        ...
                        <div class="row">
                            <div class="col-md-6 text-right" style="padding: 10px;"><label class="col-form-label" style="font-family: 'Baloo Bhaijaan', cursive;font-size: 16px;background-color: rgba(0,0,0,0.2);padding: 9px;">التاريخ</label></div>
...
<!---------------------->
    ...
    <div>
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center"><label class="col-form-label border rounded border-secondary shadow" style="padding: 10px;font-size: 21px;margin: 1px;background-color: rgb(231,231,231);color: rgb(0,0,0);padding-top: 3px;padding-bottom: 3px;">قائمة التحويلات<br>Transfert List<br></label></div>
            </div>
        </div>
    </div>
    <div class="col">
...
$('#add').click(function(){
 ...
 $('#image_form').submit(function(event){
  ...
  var id;
     ...
     var des=$('#des_id').val();
     var prix=$('#prix_id').val();
     var date=$('#date_id').val();
    $.ajax({
     url:"Bank_transfert_action.php",
     method:"POST",
     data: {des:des,prix:prix,date:date,action:action,id:id},
     success:function(data)
     {
      load_data();
      $('#image_form')[0].reset();
